...
function ShowDetailsComponentHome({ ShowDetails } : any) {
    return (
        <a href={`/${ShowDetails.url}`}>

        <div className="flex flex-col items-center justify-center p-4 mx-2 hover:bg-white/8 transition-colors duration-200 rounded-2xl">
            <div className="flex flex-col w-full items-center justify-center">
                ...
                <div className="flex-1 w-full">
                    <h1 className="text-xl text-center text-white py-0 pt-1 lg:pt-2 lg:py-2">
                        <a href={`/${ShowDetails.url}`} target="_blank" rel="noopener noreferrer">
                            {ShowDetails.title}
                        </a>
                    </h1>
                </div>
                ...
                {/* Links */}
                <div className="flex flex-row items-center justify-center w-full gap-4 pt-0 lg:pt-2 text-sm">
...
export default React.memo(ShowDetailsComponentHome);