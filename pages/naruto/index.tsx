...
import narutoArcsJson from "@/data/naruto_arcs.json"
import narutoEpisodesJson from "@/data/naruto_ratings.json"
...
export default function NarutoPage() {
  ...
  const [arcsData, setArcsData] = useState<Arc[]>([
    {
      ...
      summary: "Naruto returns to Konoha after two-and-a-half years of training, just in time to help rescue the Fifth Kazekage from Akatsuki.",
      start: 1,
      end: 5,
    ...
    },
    {
      ...
      summary: "Naruto and a new version of Team 7 use information gained from Akatsuki to try to find Sasuke.",
      start: 6,
      end: 10,
    },
    {
      title: "Tenchi Bridge Reconnaissance Mission 2",
      summary: "Naruto and a new version of Team 8 use information gained from Akatsuki to try to find Sasuke.",
      start: 11,
      end: 15,
    },
  ]);
  ...
  const ShowDetails = {
    ...
    "9anime_url": "https://9animetv.to/watch/naruto-677", //?ep=12352",
  ...
  useEffect(() => {
    ...
    setArcsData(narutoArcsJson);
    setEpisodesData(narutoEpisodesJson);
    const allFalsearray = Array(narutoArcsJson.length).fill(false);
        ...
        <div className="flex flex-1 flex-col items-center justify-center">
          <div className="flex flex-col w-full items-center justify-center">
            ...
            <div className="flex flex-row items-center justify-center w-full gap-4 pt-2 text-sm">
              ...
              <a href={ShowDetails["9anime_url"]} target="_blank" className="text-white rounded-md transition-colors duration-250 bg-[#5A2E98] hover:bg-[#704ba5] px-3 py-1">9 Anime</a>
            </div>
